...
const Color barBgColor = Color.fromRGBO(0, 184, 148, 1);

const Color barColor = Color.fromRGBO(108, 92, 231, 1);

const Color containerSelectionColor = Color.fromRGBO(99, 110, 114, 1.0);

const Color boldTextColor = Color.fromRGBO(223, 230, 233, 1.0);
