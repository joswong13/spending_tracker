...
import './Core/ViewModels/BottomNavBarScreenProvider.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ChangeNotifierProvider(builder: (ctx) => MonthProvider()),
        ChangeNotifierProvider(builder: (ctx) => BottomNavBarScreenProvider()),
      ],
      child: MaterialApp(
        theme: ThemeData(
